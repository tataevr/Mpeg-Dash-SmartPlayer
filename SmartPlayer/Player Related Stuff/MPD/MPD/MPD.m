...
@property (nonatomic, strong) XsdDurationParser *durationParser;
@end
...
- (id)init {
    self = [super init];
    if (self){
        self.durationParser = [[XsdDurationParser alloc] init];
    }
    return self;
}
...
- (StreamType)streamType {
    if (_type.length){
        return [[_type lowercaseString] isEqualToString:@"static"] ? StreamTypeStatic : StreamTypeDynamic;
    }
